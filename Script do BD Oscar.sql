...
CREATE TABLE IF NOT EXISTS Premio(
	Cod_Premio INT,
    Descricao_Premio VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS Participacao(
	A_Cod_Ator INT,
    F_Cod_Filme INT,
    PRIMARY KEY(A_Cod_Ator, F_Cod_Filme), # Para ser chave primária com duas colunas
...
('COD123', 'Melhor Roteiro'); -- Assim não funciona, pois não aceita que o código seja um texto, tem que ser inteiro na coluna especificada do Código do Prêmio

INSERT INTO Premio VALUES
(5, 'Melhor Roteiro'); -- Assim será aceita, pois atende ao domínio.

-- 3) Verificar uma Restrição de Vazio qualquer

INSERT INTO Ator VALUES
(101, 'Lazaro Ramos', 'Salvador', NULL, 'M'); -- Ocorrerá erro, pois nn pode ser Null o pais do ator

INSERT INTO Ator VALUES
(101, 'Lazaro Ramos', 'Salvador', 'BRA', 'M');
...
INSERT INTO Premio VALUES
(1, 'Melhor Ator Coadjuvante'); -- Houve duplicação, pois ja existe 1

INSERT INTO Premio VALUES
(6, 'Melhor Ator Coadjuvante'); # assim aceita
...
INSERT INTO Premiacao VALUES
(1, 1, 2022); -- Não permite devido ao fato de que o filme e o prêmio já existem e não permite receber o prêmio mesmo sendo em um ano diferente. Caso quisesse resolver, deixaria a coluna de ano como chave primária para caso queira permitir que o mesmo filme recebesse o mesmo prêmio em um ano diferente e não deixaria inserir o dado se os 3 itens da colunas se repetissem.


-- 5) Verificar a Restrição de Integridade na tabela Ator

INSERT INTO Ator VALUES
(NULL, 'Fabio Porchat', 'Rio de Janeiro', 'BRA', 'M'); -- Coluna do Cod_Ator não pode ser aluno

INSERT INTO Ator VALUES
(100, 'Fabio Porchat', 'Rio de Janeiro', 'BRA', 'M'); -- Aqui consegue inserir
